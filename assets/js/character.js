...
const character = document.querySelector(".formDados");
...
character.addEventListener("submit", function (event) {
  ...
  const nasc = document.querySelector("#dataNascimento").value;

  alert(
    `Parabens ${name}! Agora voce sera finalmente redirecionado ao jogo, boa sorte!`
  );
